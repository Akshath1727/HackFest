...
class _HomeScreenNewState extends State<HomeScreenNew> {
  ...
  final List<Task> tasks = [
    Task('assets/images/task1.png', 'Today 2:00 pm', 'With 100ml', 'Watering', true, "clivia"),
    Task('assets/images/task2.png', 'Today 4:00 pm', 'With 200ml', 'Watering', true, "Leten Rose"),
    Task('assets/images/task3.png', 'Today 7:00 pm', 'With 100ml', 'Cutting', false, "Lamb's Ear"),
  ];
        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text("MY TASKS", style: TextStyle(fontSize: 40)),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                ...
                itemBuilder: (ctx, idx) => Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            recs[idx].title,
                            style: const TextStyle(fontSize: 15, color: Color(0xFF222222), fontWeight: FontWeight.w400),
                          ),
                        ],
                      ),
                    ),
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (ctx, index) => GestureDetector(
                onTap: () {
                  Navigator.pushNamed(context, '/plantdetail', arguments: PdArgs(tasks[index].id));
                },
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text(tasks[index].title, style: const TextStyle(fontSize: 16, color: Colors.black, fontWeight: FontWeight.w600)),
        ...
        CarouselSlider(
          items: sliders.map((e) {
            return Card(
              ...
              child: ClipRRect(borderRadius: const BorderRadius.all(Radius.circular(20)), child: Image.asset(e, fit: BoxFit.cover)),
            );
          }).toList(),
          options: CarouselOptions(aspectRatio: 2.08, autoPlay: true, onPageChanged: (idx, _) => {setState(() => _selectedSlider = idx)}),
        ),
        DotsIndicator(dotsCount: sliders.length, position: _selectedSlider.toDouble(), decorator: const DotsDecorator(color: MyColors.gray2, activeColor: MyColors.primaryColor)),
      ],
    );
  }
