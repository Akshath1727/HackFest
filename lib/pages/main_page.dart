...
import 'package:vruksh_guru/screens/home_screen_new.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  void initMessaging() {
    ...
    var androidDetails = const AndroidNotificationDetails("default", "channel name");
    ...
    return Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          onTap: (int index) {
            setState(() {
              _currentIndex = index;
              _pageController.jumpTo(_currentIndex * MediaQuery.of(context).size.width);
            });
          },
          ...
          items: [
            BottomNavigationBarItem(
              icon: SvgPicture.asset(
                ...
                color: _currentIndex == 0 ? MyColors.primaryColor : MyColors.onPrimaryColor,
              ),
              label: 'Home',
            ),
            // BottomNavigationBarItem(
            ...
            //     color: _currentIndex == 1 ? MyColors.primaryColor : MyColors.onPrimaryColor,
            //   ),
            //   label: 'Shop',
            // ),
            ...
            BottomNavigationBarItem(
              icon: SvgPicture.asset(
                ...
                color: _currentIndex == 2 ? MyColors.primaryColor : MyColors.onPrimaryColor,
              ),
              label: 'Community',
            ),
            // BottomNavigationBarItem(
            ...
            //     color: _currentIndex == 3 ? MyColors.primaryColor : MyColors.onPrimaryColor,
            //   ),
            //   label: 'Profile',
            // ),
          ],
