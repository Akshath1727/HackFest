// import 'package:vruksh_guru/pages/schedule.dart';
// import 'package:vruksh_guru/services/appointment_service.dart';
...
//                                       children: [
//                                         CircleAvatar(
//                                           backgroundImage: AssetImage("assets/Asma_Khan.png"),
//                                         ),
//                                         SizedBox(
//                                           width: 10,
//                                         ),
...
//                                             style: ElevatedButton.styleFrom(backgroundColor: Colors.green, textStyle: TextStyle(fontWeight: FontWeight.bold)),
//                                             child: Text('Accept'),
//                                             onPressed: () async {
//                                               var accepting = await AppointmentService().updateAppointment(snapshot.data!["data"][index]["_id"]);
//                                               setState(() {});
//                                             },
//                                           ),
//                                         )
